...
async function findProductCode(productCode) {
    try {
        ...
        const result = await collection.findOne({ code: productCode }, { projection: { name: 0, ID: 0, code: 0, price: 0, seller: 0, country: 0, type: 0, date: 0, category: 0, desript: 0, images: 0} })
